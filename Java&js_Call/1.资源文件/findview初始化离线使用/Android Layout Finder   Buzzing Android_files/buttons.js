...
<html>
  ...
  <body>
    ...
    <div id="frame">
      ...
      <strong class="short-error">Lantern could not access the server at w.sharethis.com.</strong>
      ...
      <ul>
        ...
        <li>
          Does the error message <code>Still unable to dial tcp://w.sharethis.com:80 after 3 attempts</code> mean something to you?
        </li>
      </ul>
    </div>
